...
function App() {
  return (
    <>
      ...
      {/* CONTENIDO (NO TOCAMOS LOS TESTIMONIOS) */}
      <div className="App">
        ...
        <Testimonio
          ...
          pais='España'
          imagen='Ourense'
          testimonio='Ciudad interior de Galicia, situada en el interior de Galicia a orillas del río Miño, famosa por su patrimonio histórico y sus aguas termales.'
        />
        ...
        <Testimonio
          ...
          testimonio='Ciudad histórica y capital de Galicia, famosa por su catedral y como destino final del Camino de Santiago.'
        />
        ...
        <Testimonio
          ...
          pais='España'
          imagen='Vigo'
          testimonio='Es la ciudad más grande de Galicia y una importante zona portuaria junto a la Ría de Vigo.'
        />
      </div>
    </>
  );
